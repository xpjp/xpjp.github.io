...
<u>XPが開始する前に</u>、潜在的なユーザーがXPの使用例を理解することが重要です。
ほとんどの暗号通貨では、使用例は単なる空想でしかありません。
...
その時以来、XPは人生の多くの異なる分野で遍在してきました。ゲーミフィケーションの流行は、かつてはゲームのために用意された「経験値」という概念を、現実に利用することを可能にしました。
経験は、洗濯をすることから犬の散歩をすることまで、非常に多岐に渡ります。
XPは、使用者へのポイントの生成から支出パートナーへ戻るまでのトークンの自由な流れを可能にするインセンティブ化構造を提供することによってこれを活用しようとしています。

[^1]: 1977年のDungeons and Dragons Basic Setの第1版で最初に言及されました。

# II. 市場規模を理解する
暗号通貨の価格とその供給の関連付けは暗号通貨の投資コミュニティによって大きく左右されています。
しかし、このロジックには、トークンの供給が価格を決定するとは限らないという欠点があり、
むしろ需要と使用法によるものです。私たちは需要を構築することと使用法を作り出すことに没頭しています。
...
### 観光では:
* ヨーロッパでは、観光と活動が年間**約400億米ドル**を占めています[^3]
* 旅行者はショッピング、お土産や夜の娯楽を合計した額よりも、観光や体験により費用をかける可能性が高くなっています[^4]
...
**これらの異なるエコシステム間を横断したり間を取り持つような動機を与える単一の手段はありませんでした。 - XPが登場するまでは。**
...
XPはより幅広くユーザーに使用されるよう設計されているので、これが何を意味するのかを正確に説明することに時間を費やした方がよいでしょう。
より深い説明はオンライン上の様々なところにありますが、
暗号通貨の正確性とその生成方法について、簡単に説明します。

最初の暗号通過であるBitcoinは、Satoshi Nakamotoを名乗る人物によって開発されました。
